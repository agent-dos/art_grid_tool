...
class ImageCanvas:
    ...
    def bind_events(self):
        ...
        self.canvas.bind("<MouseWheel>", self.callbacks['mouse_zoom'])
        self.canvas.bind("<Button-4>", self.callbacks['mouse_zoom'])
        self.canvas.bind("<Button-5>", self.callbacks['mouse_zoom'])